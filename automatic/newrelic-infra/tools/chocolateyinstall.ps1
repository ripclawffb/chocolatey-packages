...
$url64      = 'https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.1.71.3.msi'
...
$packageArgs = @{
  ...
  checksum64     = '7e8a3d65e51ffc49f0cbb90992380f595a55476aee692efa66c629fc913e4028'
