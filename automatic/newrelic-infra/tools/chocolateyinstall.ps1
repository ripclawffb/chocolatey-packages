...
$url64      = 'https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.1.72.7.msi'
...
$packageArgs = @{
  ...
  checksum64     = '0fcbd610024b8573986d82e6ecc30c9e22579d7714f8667d918799a7534e7d6d'
