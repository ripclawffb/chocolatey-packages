...
$url64      = 'https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.1.74.2.msi'
...
$packageArgs = @{
  ...
  checksum64     = 'e985c3a6bb65ac1716eee3a9fb6b73ab3ab90d8d4a1a15812f4024b0f032eeac'
